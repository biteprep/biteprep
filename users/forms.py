...
# FIX: We need 'reverse' for the __init__ method.
...
class CustomUserCreationForm(UserCreationForm):
    ...
    # FIX: Define the field with a simple placeholder label. We will update it dynamically.
    ...
    # FIX: Re-introduce the __init__ method to dynamically create the label AFTER URLs are loaded.
    def __init__(self, *args, **kwargs):
        ...
        # Get the URLs for the legal pages. 'reverse' is safe to use here.
